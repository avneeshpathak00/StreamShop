...
import com.ecommerce.shop.excepions.APIException;
import com.ecommerce.shop.excepions.ResourceNotFoundException;
import com.ecommerce.shop.model.Cart;
import com.ecommerce.shop.model.Category;
import com.ecommerce.shop.model.Product;
import com.ecommerce.shop.payload.CartDTO;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse searchProductByKeyword(String keyword, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        List<ProductDTO> productDTOS = products.stream().map(product -> modelMapper
                ...
                .toList();
        if (products.isEmpty()) {
            throw new APIException("Products not fount with keyword: " + keyword);
        }
        ProductResponse productResponse = new ProductResponse();
        productResponse.setContent(productDTOS);
        productResponse.setPageNumber(pageProducts.getNumber());
